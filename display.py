...
class Draw:
    ...
    def drawStartScreen(self, board):
        ...
        gText = gameFont.render("B", True, self.fontColour)
        greedyText = gameFont.render("FOR BOT", True, self.fontColour)
        sText = gameFont.render("P", True, self.fontColour)
        startText = gameFont.render("FOR PLAYER", True, self.fontColour)
        self.screen.blit(pressText, (2*self.window.blockSize, ((board.height/2)-3)*self.window.blockSize))
        self.screen.blit(gText, (4*self.window.blockSize, ((board.height/2)-1)*self.window.blockSize))
        self.screen.blit(greedyText, (self.window.blockSize, ((board.height/2)+1)*self.window.blockSize))
        self.screen.blit(pressText, (12*self.window.blockSize, ((board.height/2)-3)*self.window.blockSize))
        self.screen.blit(sText, (21*self.window.blockSize, ((board.height/2)-1)*self.window.blockSize))
