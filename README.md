>This project is built on [tetris-selfplay](https://github.com/mpdcampbell/tetris-selfplay) by Michael Campbell (mpdcampbell), used as the base game engine (board, tetromino, rendering). The greedy AI (`greedyPlayer.py`) and MDP/Expectimax solver (`mdpPlayer.py`) are original work written for this course project.
# tetris-selfplay
